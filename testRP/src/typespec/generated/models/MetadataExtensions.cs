...
namespace Microsoft.MyResourceProvider.Service.Models
{
    ...
    {
        /// <summary>
        /// Copy the properties of this Metadata to another Metadata
        /// </summary>
        ...
        public static void CopyTo(this Metadata source, Metadata target, CopySettings copySettings = CopySettings.UsePutSemantics)
        {
            var helper = new MetadataCopyHelper();
            switch (copySettings)
            {
