...
import { getHeaderFieldName, getHttpOperation, getOperationVerb, isBody, isHeader, } from "@typespec/http";
import { getActionDetails, getResourceLocationType, getResourceOperation, } from "@typespec/rest";
import { extractLroStates, FinalOperationKey, getFinalLocationValue, getLroResult, getOperationLink, getOperationLinks, getPollingLocationInfo, isFinalLocation, isPollingLocation, PollingOperationKey, pollingOptionsKind, } from "./decorators.js";
/**
...
function createFinalOperationLink(program, model, property) {
    ...
    if (property.type.kind === "Scalar" && property.type.name === "ResourceLocation") {
        resourceType = (_a = property.type.templateMapper) === null || _a === void 0 ? void 0 : _a.args[0];
    }
    ...
    return {
        ...
        responseModel: (_b = override !== null && override !== void 0 ? override : resourceType) !== null && _b !== void 0 ? _b : model,
        target: {
            kind: "link",
...
function createLroMetadata(program, operation, context) {
    ...
    if (finalState === undefined || model === undefined || context.pollingStep === undefined)
        return undefined;
    const logicalPathName = ((_a = context.finalStep) === null || _a === void 0 ? void 0 : _a.kind) === "pollingSuccessProperty"
...
function createOperationLink(program, modelProperty) {
    ...
    if (isBody(program, modelProperty))
        location = "Self";
    return {
        kind: "link",
        location: location,
...
function getFinalStateVia(program, operation, context) {
    ...
    let model = ((_a = context.originalModel) === null || _a === void 0 ? void 0 : _a.name) !== undefined ? context.originalModel : undefined;
    let finalState = FinalStateValue.originalUri;
    const resOp = getLogicalResourceOperation(program, operation, model);
    if (operationAction !== undefined || (resOp === null || resOp === void 0 ? void 0 : resOp.operation) === "delete") {
        finalState = FinalStateValue.operationLocation;
        model = (_c = (_b = context.pollingStep) === null || _b === void 0 ? void 0 : _b.responseModel) !== null && _c !== void 0 ? _c : context.originalModel;
    }
    if (context.finalStep &&
        context.finalStep.kind !== "noPollingResult" &&
        (context.finalStep.kind !== "pollingSuccessProperty" ||
            (resOp === null || resOp === void 0 ? void 0 : resOp.operation) === undefined ||
    ...
    if ((operationAction !== undefined &&
        ...
        context.statusMonitorStep !== undefined) ||
        ((resOp === null || resOp === void 0 ? void 0 : resOp.operation) === "delete" &&
        ...
        if (info !== undefined) {
            model = (_d = info.successType) !== null && _d !== void 0 ? _d : program.checker.voidType;
            finalState = getStatusFromLinkOrReference(program, operation, (_e = context.statusMonitorStep) === null || _e === void 0 ? void 0 : _e.target);
...
function getPollingStep(program, modelOrOperation, context) {
    ...
    function getModel(property) {
        return (property === null || property === void 0 ? void 0 : property.type.kind) === "Model" ? property.type : undefined;
    }
    let info;
    ...
    if (((_a = context.pollingOperationLink) === null || _a === void 0 ? void 0 : _a.parameterMap) === undefined)
        return undefined;
    const statusMonitorOverride = (_c = (_b = context.pollingOperationLink) === null || _b === void 0 ? void 0 : _b.result) === null || _c === void 0 ? void 0 : _c.statusMonitor;
...
function getStatusMonitorInfo(program, modelOrLink, pollingOverride) {
    if ((pollingOverride === null || pollingOverride === void 0 ? void 0 : pollingOverride.kind) === pollingOptionsKind.StatusMonitor) {
        return {
...
function processFinalLink(program, modelOrOperation, context) {
    ...
    const overrideModel = (_b = (_a = context.finalOperationLink) === null || _a === void 0 ? void 0 : _a.result) === null || _b === void 0 ? void 0 : _b.type;
        ...
        case "Operation":
            {
                ...
                context.finalStep = createFinalOperationLink(program, overrideModel !== null && overrideModel !== void 0 ? overrideModel : model, property);
            }
            break;
        case "Model":
            {
                ...
                if (outProperties === undefined || outProperties.length !== 1)
                    return;
                context.finalStep = createFinalOperationLink(program, overrideModel !== null && overrideModel !== void 0 ? overrideModel : modelOrOperation, outProperties[0]);
            }
            break;
    }
}
function processFinalReference(program, operation, context) {
    ...
    if (link === undefined || link.parameterMap === undefined || ((_a = link.result) === null || _a === void 0 ? void 0 : _a.type) === undefined)
        return;
    ...
    context.finalStep = {
        ...
        responseModel: (_b = link.result) === null || _b === void 0 ? void 0 : _b.type,
        target: reference,
    };
}
...
function processStatusMonitorLink(program, modelOrOperation, context) {
    var _a, _b, _c;
    let lroData;
    if (((_b = (_a = context.pollingOperationLink) === null || _a === void 0 ? void 0 : _a.result) === null || _b === void 0 ? void 0 : _b.statusMonitor) && ((_c = context.pollingOperationLink) === null || _c === void 0 ? void 0 : _c.link)) {
...
function processStatusMonitorReference(program, referencedOperation, context) {
    ...
    if (pollingReference === undefined)
        return undefined;
    context.statusMonitorInfo = (_a = pollingData.result) === null || _a === void 0 ? void 0 : _a.statusMonitor;
    ...
    if (context.finalStep === undefined && finalData !== undefined) {
        ...
        const finalModel = (_b = finalData === null || finalData === void 0 ? void 0 : finalData.result) === null || _b === void 0 ? void 0 : _b.type;
    ...
    if (context.finalStep === undefined &&
        ((_d = (_c = pollingData.result) === null || _c === void 0 ? void 0 : _c.statusMonitor) === null || _d === void 0 ? void 0 : _d.successProperty) !== undefined &&
    ...
    const responseModel = (_e = pollingData.result) === null || _e === void 0 ? void 0 : _e.type;
