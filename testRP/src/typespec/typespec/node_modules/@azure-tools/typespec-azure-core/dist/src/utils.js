...
export function getSuccessResponse(program, operation) {
    var _a;
    const candidates = (_a = filterResponseModels(operation, (response) => !isErrorModel(program, response))) === null || _a === void 0 ? void 0 : _a.filter((m) => {
        var _a, _b, _c;
        const prop = getStatusCodeProperty(program, m);
        return (prop === undefined ||
            (((_a = prop.type) === null || _a === void 0 ? void 0 : _a.kind) === "String" && ((_b = prop.type.value) === null || _b === void 0 ? void 0 : _b.startsWith("2"))) ||
            (((_c = prop.type) === null || _c === void 0 ? void 0 : _c.kind) === "Number" && prop.type.value >= 200 && prop.type.value < 300));
    });
...
export function getAllProperties(model, collection) {
    const outCollection = collection !== null && collection !== void 0 ? collection : new Map();
