...
export function $traitSource(context, target, traitName) {
...
export function $trait(context, target, traitName) {
    ...
    traitName = traitName !== null && traitName !== void 0 ? traitName : getTypeName(target, { namespaceFilter: (ns) => false });
...
export function $traitContext(context, target, traitContext) {
    context.program
...
export function $traitLocation(context, target, traitLocation) {
...
export function $traitAdded(context, target, addedVersion) {
...
export function $addTraitProperties(context, target, traitModel, traitLocation, traitContexts) {
    ...
    for (const [_, traitEnvelope] of traitModel.properties) {
        ...
        if (traitName && !appliedTraits.has(traitName)) {
            ...
            for (const [_, traitProperty] of traitEnvelope.type.properties) {
                ...
                if (checkTraitPropertyCriteria(program, traitProperty, contextsOverride !== null && contextsOverride !== void 0 ? contextsOverride : contexts, traitLocation, normalizeTraitContexts(program, traitContexts))) {
...
export function $applyTraitOverride(context, target, traitModel) {
...
export function $ensureTraitsPresent(context, target, traitModel, expectedTraits) {
...
export function $ensureAllQueryParams(context, target, paramModel) {
...
export function $ensureAllHeaderParams(context, target, paramModel) {
    for (const [_, param] of paramModel.properties) {
