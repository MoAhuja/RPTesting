    ...
    create(context) {
        ...
        function getContainerRoutePrefix(container) {
            ...
            if (container.kind === "Operation") {
                return ((_a = getContainerRoutePrefix(container.interface)) !== null && _a !== void 0 ? _a : getContainerRoutePrefix(container.namespace));
            }
        ...
        function checkOperationReferences(op, originalOp) {
            ...
            if (op !== undefined) {
                ...
                const container = (_a = op.interface) !== null && _a !== void 0 ? _a : op.namespace;
                const originalContainer = (_b = originalOp.interface) !== null && _b !== void 0 ? _b : originalOp.namespace;
