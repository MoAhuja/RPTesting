...
export function resolveRequestVisibility(program, operation, verb) {
    ...
    let visibility = parameterVisibility !== null && parameterVisibility !== void 0 ? parameterVisibility : defaultVisibility;
    // If the verb is PATCH, then we need to add the patch flag to the visibility in order for
    // later processes to properly apply it
    if (verb === "patch") {
        visibility |= Visibility.Patch;
...
type, visibility, isMetadataCallback = isMetadata, rootMapOut) {
    ...
    while (!queue.isEmpty()) {
        ...
        for (const property of walkPropertiesInherited(model)) {
            const root = rootOpt !== null && rootOpt !== void 0 ? rootOpt : property;
            ...
            if (isApplicableMetadataOrBody(program, property, visibility, isMetadataCallback)) {
                ...
                rootMapOut === null || rootMapOut === void 0 ? void 0 : rootMapOut.set(property, root);
            }
...
export function createMetadataInfo(program, options) {
    var _a;
    const canonicalVisibility = (_a = options === null || options === void 0 ? void 0 : options.canonicalVisibility) !== null && _a !== void 0 ? _a : Visibility.None;
    ...
    function isPayloadProperty(property, visibility, keepShareableProperties) {
        ...
        if (!isVisible(program, property, visibility)) {
            ...
            // visibility.
            keepShareableProperties || (keepShareableProperties = visibility === canonicalVisibility);
