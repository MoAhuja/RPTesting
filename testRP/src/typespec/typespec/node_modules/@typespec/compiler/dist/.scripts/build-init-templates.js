...
const pkgJson = JSON.parse((await readFile(resolve(packageRoot, "package.json"))).toString("utf-8"));
...
await writeFile(resolve(packageRoot, "templates", "scaffolding.json"), JSON.stringify(builtInTemplates, null, 2));
//# sourceMappingURL=build-init-templates.js.map