  ...
  <dict>
    ...
    <dict>
      ...
      <dict>
        ...
        <string>comment.block.tsp</string>
        <key>match</key>
        <string>(?x)((@)(?:param|template))\s+(\b[_$[:alpha:]][_$[:alnum:]]*\b)\b</string>
        <key>captures</key>
        <dict>
          <key>1</key>
          <dict>
      ...
      <dict>
        ...
        <array>
          ...
          <dict>
            <key>include</key>
            <string>#model-spread-property</string>
          </dict>
          <dict>
            <key>include</key>
            <string>#punctuation-semicolon</string>
      ...
      <key>model-spread-property</key>
      <dict>
        <key>name</key>
        <string>meta.model-spread-property.typespec</string>
        <key>begin</key>
        <string>\.\.\.</string>
        <key>beginCaptures</key>
        <dict>
