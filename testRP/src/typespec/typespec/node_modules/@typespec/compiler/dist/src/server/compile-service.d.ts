...
import { CompilerHost, TypeSpecScriptNode } from "../core/index.js";
...
export declare function createCompileService({ compilerHost, serverHost, fileService, fileSystemCache, log, }: CompileServiceOptions): CompileService;
