import { StringLiteral } from "../core/index.js";
 ...
 */
export declare function getDocDataInternal(program: Program, target: Type, key: DocTarget): DocData | undefined;
/**
 * Get the documentation information for the given type. In most cases you probably just want to use {@link getDoc}
 * @param program Program
 * @param target Type
...
export declare function $returnsDoc(context: DecoratorContext, target: Operation, text: string): void;
/**
...
export declare function $errorsDoc(context: DecoratorContext, target: Operation, text: string): void;
/**
...
export declare function $withoutOmittedProperties(context: DecoratorContext, target: Model, omitProperties: StringLiteral | Union): void;
 ...
 * ```
 */
export declare function $deprecated(context: DecoratorContext, target: Type, message: string): void;
/**
...
export declare function $parameterVisibility(context: DecoratorContext, entity: Operation, ...visibilities: string[]): void;
/**
...
export declare function $returnTypeVisibility(context: DecoratorContext, entity: Operation, ...visibilities: string[]): void;
/**
