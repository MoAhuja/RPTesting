...
import { resolveTypeSpecEntrypoint, resolveTypeSpecEntrypointForDir, } from "./entrypoint-resolution.js";
...
import { deepEquals, doIO, findProjectRoot, isDefined, mapEquals, mutate, resolveTspMain, } from "./util.js";
...
export async function compile(host, mainFile, options = {}, oldProgram // NOTE: deliberately separate from options to avoid memory leak by chaining all old programs together.
    ...
    async function resolveEmitterModuleAndEntrypoint(basedir, emitterNameOrPath) {
        ...
        const [module, diagnostics] = await resolveJSLibrary(emitterNameOrPath, basedir, locationContext);
        if (!module) {
    ...
    async function loadLibrary(basedir, libraryNameOrPath) {
        ...
        return {
            ...
            linter: entrypoint === null || entrypoint === void 0 ? void 0 : entrypoint.esmExports.$linter,
        };
    }
