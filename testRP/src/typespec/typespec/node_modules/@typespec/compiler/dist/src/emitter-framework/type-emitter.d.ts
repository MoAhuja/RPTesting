import { BooleanLiteral, Enum, EnumMember, Interface, IntrinsicType, Model, ModelProperty, Namespace, NumericLiteral, Operation, Program, Scalar, StringLiteral, StringTemplate, Tuple, Type, Union, UnionVariant } from "../core/index.js";
