...
class RekeyableMapImpl {
    ...
    *keys() {
    ...
    rekey(existingKey, newKey) {
        ...
        const newKeyItem = __classPrivateFieldGet(this, _RekeyableMapImpl_keys, "f").get(newKey);
        if (newKeyItem) {
            __classPrivateFieldGet(this, _RekeyableMapImpl_values, "f").delete(newKeyItem);
        }
        keyItem.key = newKey;
