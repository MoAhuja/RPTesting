...
function getEncodedName(program, target, mimeType) {
    ...
    const resolvedMimeType = (mimeTypeObj === null || mimeTypeObj === void 0 ? void 0 : mimeTypeObj.suffix)
        ? `${mimeTypeObj.type}/${mimeTypeObj.suffix}`
        : mimeType;
    return (_a = program.stateMap(encodedNameKey).get(target)) === null || _a === void 0 ? void 0 : _a.get(resolvedMimeType);
}
/**
...
export function resolveEncodedName(program, target, mimeType) {
    var _a;
    return (_a = getEncodedName(program, target, mimeType)) !== null && _a !== void 0 ? _a : target.name;
}
/**
