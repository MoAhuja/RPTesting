...
import { handleInternalCompilerError, withCliHost, withCliHostAndDiagnostics, } from "./utils.js";
async function main() {
    ...
    await yargs(process.argv.slice(2))
        ...
        .command("install", "Install typespec dependencies", () => { }, withCliHost((host) => installTypeSpecDependencies(host, process.cwd())))
        .command("info", "Show information about current TypeSpec compiler.", () => { }, withCliHostAndDiagnostics((host) => printInfoAction(host)))
