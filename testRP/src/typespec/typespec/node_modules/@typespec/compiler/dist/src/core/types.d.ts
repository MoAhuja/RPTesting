...
export type Type = Model | ModelProperty | Scalar | Interface | Enum | EnumMember | TemplateParameter | Namespace | Operation | StringLiteral | NumericLiteral | BooleanLiteral | StringTemplate | StringTemplateSpan | Tuple | Union | UnionVariant | IntrinsicType | FunctionType | Decorator | FunctionParameter | ObjectType | Projection;
...
export type DocTag = DocReturnsTagNode | DocErrorsTagNode | DocParamTagNode | DocTemplateTagNode | DocUnknownTagNode;
