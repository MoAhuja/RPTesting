...
import { CompilerHost, DiagnosticTarget, NoTarget, RekeyableMap, SourceFile, SourceFileKind, Sym, SymbolTable } from "./types.js";
...
export declare function getSourceFileKindFromExt(path: string): SourceFileKind | undefined;
