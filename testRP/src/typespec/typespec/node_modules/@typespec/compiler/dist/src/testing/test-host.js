...
function createTestCompilerHost(virtualFs, jsImports, options) {
    ...
    if (!(options === null || options === void 0 ? void 0 : options.excludeTestLib)) {
    ...
    return {
        ...
        ...options === null || options === void 0 ? void 0 : options.compilerHostOverrides,
    };
}
export async function createTestFileSystem(options) {
    const virtualFs = createStringMap(!!(options === null || options === void 0 ? void 0 : options.caseInsensitiveFileSystem));
    const jsImports = createStringMap(!!(options === null || options === void 0 ? void 0 : options.caseInsensitiveFileSystem));
...
export async function createTestRunner(host) {
    const testHost = host !== null && host !== void 0 ? host : (await createTestHost());
...
async function createTestHostInternal() {
    ...
    fileSystem.addJsFile(".tsp/test-lib/test.js", {
        ...
        $test(_, target, nameLiteral) {
            let name = nameLiteral === null || nameLiteral === void 0 ? void 0 : nameLiteral.value;
            if (!name) {
