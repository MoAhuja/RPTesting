...
import { Availability, findVersionedNamespace, getAvailabilityMap, getMadeOptionalOn, getRenamedFrom, getReturnTypeChangedFrom, getTypeChangedFrom, getUseDependencies, getVersion, getVersionDependencies, getVersions, } from "./versioning.js";
...
function validateMultiTypeReference(program, source, options) {
    ...
    for (const [version, type] of versionTypeMap) {
        ...
        const availability = (_a = availMap === null || availMap === void 0 ? void 0 : availMap.get(version.name)) !== null && _a !== void 0 ? _a : Availability.Available;
...
function validateVersionedPropertyNames(program, source) {
    ...
    for (const value of values) {
        ...
        for (const [version, name] of nameMap) {
            if (name === undefined)
                continue;
            (_a = versionedNameMap.get(version)) === null || _a === void 0 ? void 0 : _a.push(name);
        }
    }
    ...
    for (const [version, names] of versionedNameMap.entries()) {
        ...
        for (const name of names) {
            const count = (_b = nameCounts.get(name)) !== null && _b !== void 0 ? _b : 0;
...
function getAvailabilityMapWithParentInfo(program, type) {
    ...
    return base !== null && base !== void 0 ? base : parentMap;
}
/**
...
function validateAvailabilityForRef(program, sourceAvail, targetAvail, source, target, sourceOptions, targetOptions) {
