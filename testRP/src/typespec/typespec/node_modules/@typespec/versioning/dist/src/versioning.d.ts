...
import { DecoratorContext, Enum, EnumMember, Model, ModelProperty, Namespace, ObjectType, Operation, Program, ProjectionApplication, Scalar, Type, Union, UnionVariant } from "@typespec/compiler";
...
export declare function $added(context: DecoratorContext, t: Model | ModelProperty | Operation | Enum | EnumMember | Union | UnionVariant | Scalar | Interface, v: EnumMember): void;
...
export declare function $renamedFrom(context: DecoratorContext, t: Model | ModelProperty | Operation | Enum | EnumMember | Union | UnionVariant | Scalar | Interface, v: EnumMember, oldName: string): void;
